...
describe('orderController.getAllOrder', () => {
    ...
    test('should return 200 - order found', async () => {
        ...
        expect(res.json).toHaveBeenCalledWith({ message: "Orders find successfully", result: result.rows[0] });
    });
...
describe('orderController.getOrderById', () => {
    ...
    test('should return 200 - order found', async () => {
        ...
        expect(res.status).toHaveBeenCalledWith(200);
        expect(res.json).toHaveBeenCalledWith({ message: "Order find successfully", result: result.rows[0] });
    });

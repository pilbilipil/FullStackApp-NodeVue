...
let itemArray = computed(() => store.getters.getItemArray);
...
function showCheckedArray() {
  ...
  checkedElementsValues.length = 0;
...
<template>
  <button
    class="absolute start-0 top-0 m-16 bg-white text-emerald-700 font-bold hover:text-black hover:bg-white hover:text-black"
    @click="back"
  >
  ...
  <h1 class="font-bold text-3xl text-emerald-800 uppercase m-8">Cart</h1>
  <div>
    <div class="inline-flex justify-content items-center my-4">
      <label class="text-emerald-700 font-bold mx-2 text-sm" for="">washing outside</label
      ><input class="ser" value="1" type="checkbox" />
      <label class="text-emerald-700 font-bold mx-2 text-sm" for="">washing inside</label
      ><input class="ser" value="2" type="checkbox" />
      <label class="text-emerald-700 font-bold mx-2 text-sm" for="">washing full</label
      ><input class="ser" value="3" type="checkbox" />
      <label class="text-emerald-700 font-bold mx-2 text-sm" for="">surface inspection</label
      ><input class="ser" value="4" type="checkbox" />
      <label class="text-emerald-700 font-bold mx-2 text-sm" for="">thorough inspection</label
      ><input class="ser" value="5" type="checkbox" />
      <label class="text-emerald-700 font-bold mx-2 text-sm" for="">full inspection</label
      ><input class="ser" value="6" type="checkbox" />
      <label class="text-emerald-700 font-bold mx-2 text-sm" for="">fast repair</label
      ><input class="ser" value="7" type="checkbox" />
      <label class="text-emerald-700 font-bold mx-2 text-sm" for="">full repair</label
      ><input class="ser" value="8" type="checkbox" />
      <label class="text-emerald-700 font-bold mx-2 text-sm" for="">replace repair</label
      ><input class="ser" value="9" type="checkbox" />
    </div>
  </div>
  <div class="flex flex-row justyfi-center items-center w-screen bg-emerald-50">
    <!-- item block -->
    <div
      class="grid grid-cols-3 overflow-y-scroll no-scrollbar gap-4 w-[150vh] p-8 h-[70vh]"
    >
      <div
        class="grid grid-cols-1 max-w-80 max-h-44 bg-white border border-gray-200 rounded-lg shadow-xl"
      ...
      >
        <div class="p-5">
          ...
          <button
            class="items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 dark:hover:bg-black"
    ...
    >
      <h2 class="uppercase text-emerald-800 font-bold mt-6">Info</h2>
      ...
      <button
    class="flex mt-4 bg-emerald-800 text-white hover:bg-white hover:text-black"
    @click="createOrder"
  >
    Create order
  </button>

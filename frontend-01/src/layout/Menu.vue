...
<div class="relative w-full">
  <div class="bg-emerald-800 w-full fixed top-0 left-0 border-b-2 border-white">
    <nav class="container px-6 py-1 mx-auto md:flex md:justify-between md:items-center">
      <div class="flex items-center justify-between">
        <router-link to="/" class="text-xl font-bold text-white md:text-2xl">
            <div class="inline-flex justify-center hover:text-emerald-300">
            <p>CarServiceShop_</p>
            <svg class="w-10 h-10 text-white hover:text-emerald-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
      ...
      <ul :class="showMenu ? 'flex' : 'hidden'"
        ...
        <li class="text-sm font-bold text-white hover:text-emerald-300">
            <router-link class="inline-flex hover:text-emerald-300" to="/">
              Home
              <svg class="w-6 h-6 text-white hover:text-emerald-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <li class="text-sm font-bold text-white hover:text-emerald-300">
        <router-link class="inline-flex hover:text-emerald-300" to="/shop">Shop
          <svg class="w-6 h-6 text-white hover:text-emerald-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <li class="text-sm font-bold text-white hover:text-emerald-300">
            <router-link class="inline-flex hover:text-emerald-300" to="/contact">
              Contact
              <svg class="w-6 h-6 text-white hover:text-emerald-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <li class="text-sm font-bold text-white hover:text-emerald-300" :class="token ? 'flex' : 'hidden'">
            <router-link class="inline-flex hover:text-emerald-300" :to="token ? '/cart' : ''">
                {{ token ? 'Cart' : '' }}
        ...
        <li class="text-sm font-bold text-white hover:text-emerald-300">
            <router-link class="inline-flex hover:text-emerald-300" :to="token ? '/profile' : '/login'">
                {{ token ? 'Profile' : 'Login' }}
              <svg class="w-6 h-6 text-white hover:text-emerald-300 ml-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <button v-show="Boolean(token)" class="bg-emerald-800 hover:bg-emerald-800" @click="exit">
            <svg class="w-6 h-6 text-white hover:text-red-400 hover:bg-emerald-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.6" d="m15 9-6 6m0-6 6 6m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
            </svg>
        </button>
      </ul>
    </nav>

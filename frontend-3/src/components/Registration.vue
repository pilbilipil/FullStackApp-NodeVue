...
<template>
  ...
  <div class="flex flex-col">
    ...
    <div class="grid grid-cols-2 gap-2">
      ...
      <input type="email" placeholder="email" :class="emailClass" v-model="email"/>
      <input type="password"  placeholder="password" :class="passwordClass" v-model="userPassword"/>
      <input placeholder="phone" :class="phoneClass" v-model="phone" />
      <input placeholder="day/month/year" :class="birthClass" v-model="dateOfBirth"/>
    </div>
    <div class="grid grid-cols-2 gap-2">
      <select

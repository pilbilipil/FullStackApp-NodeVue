...
function showCheckedArray() {
  let checked_elements = document.querySelectorAll('input[type="checkbox"]:checked');
...
<template>
  <button class="absolute start-0 top-0 m-16 bg-black text-white hover:bg-white hover:text-black" @click="back">Back</button>
  <button class="absolute end-0 top-0 m-16 bg-black text-white hover:bg-white hover:text-black" @click="createOrder">Create order</button>
  ...
  <div>
    ...
    <div class="inline-flex justify-content items-center my-4">
        <label class="text-slate-500 font-bold mx-2" for="">washing outside</label><input class="ser" value="1" type="checkbox">
        <label class="text-slate-500 font-bold mx-2" for="">washing inside</label><input class="ser" value="2" type="checkbox">
        <label class="text-slate-500 font-bold mx-2" for="">washing full</label><input class="ser" value="3" type="checkbox">
        <label class="text-slate-500 font-bold mx-2" for="">surface inspection</label><input class="ser" value="4" type="checkbox">
        <label class="text-slate-500 font-bold mx-2" for="">thorough inspection</label><input class="ser" value="5" type="checkbox">
        <label class="text-slate-500 font-bold mx-2" for="">full inspection</label><input class="ser" value="6" type="checkbox">
        <label class="text-slate-500 font-bold mx-2" for="">fast repair</label><input class="ser" value="7" type="checkbox">
        <label class="text-slate-500 font-bold mx-2" for="">full repair</label><input class="ser" value="8" type="checkbox">
        <label class="text-slate-500 font-bold mx-2" for="">replace repair</label><input class="ser" value="9" type="checkbox">
    </div>
  </div>
  <div class="flex flex-row justyfi-center items-center w-screen bg-slate-50">
    <!-- item block -->
    <div class="grid grid-cols-3 overflow-y-scroll no-scrollbar gap-4 w-[150vh] p-8 h-[70vh]">
      <div
    ...
    <!-- line -->
     <!-- <div class="h-[80vh] shadow-lg border-2 border-black mx-8"></div> -->
    <!-- calculate block -->
     <div class="top-0 h-[60vh] ml-16 border-2 rounded bg-white border-gray-200 px-16 shadow-lg text-start">
        ...
        <p class="text-gray-400 mt-4">sales: -{{Math.floor(totalPrice * 0.1)}}$</p>

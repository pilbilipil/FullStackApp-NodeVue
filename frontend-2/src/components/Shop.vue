...
<template>
  ...
  <div class="flex inline-flex bg-[#FAFAFA] rounded-md mb-4 border-2 border-emerald-600">
  <input placeholder="find by id" class="bg-[#FAFAFA] rounded shadow-none pl-2">
  <svg class="w-8 h-8 text-gray-900 ml-1 hover:text-emerald-600 border-emerald-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    ...
    >
      <div class="p-5">
        ...
        <div class="grid grid-cols-2 gap-2">
          <p class="mb-3 font-normal text-sm text-gray-400">Type: {{ value.productType }}</p>
          <p class="mb-3 font-normal text-sm text-gray-400">Country: {{ value.productCountry }}</p>
          <p class="mb-3 font-normal text-sm text-gray-400">Count: {{ value.productCount }}</p>
          <p class="mb-3 font-normal text-sm text-gray-400">Price: {{ value.productPrice }}$</p>
        </div>
        <p
          href="#"

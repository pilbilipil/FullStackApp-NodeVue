      ...
      <ul :class="showMenu ? 'flex' : 'hidden'"
        ...
        <li class="text-sm font-bold text-white hover:text-emerald-300">
            <router-link class="inline-flex hover:text-emerald-300" to="/">
              <div class="inline-flex hover:text-emerald-300">  
              Home
              <svg class="w-6 h-6 hover:text-emerald-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <li class="text-sm font-bold text-white hover:text-emerald-300">
            <router-link :to="token ? '/profile' : '/login'">
              <div class="inline-flex hover:text-emerald-300">
                {{ token ? 'Profile' : 'Login' }}
              <svg class="w-6 h-6 hover:text-emerald-300 ml-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
